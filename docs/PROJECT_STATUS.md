...
- `SharkAI` utilise le `Heartbeat` Wildlife central et déplace l'assemblage ancré par pivot, avec orientation progressive. Il patrouille dans le Terrain Water à 7 studs/s dans un rayon de 45 studs, détecte toutes les 0,25 seconde les nageurs valides dans un rayon de 400 studs, les poursuit à 30 studs/s jusqu'au leash territorial de 600 studs, puis revient à 9 studs/s. Une cible déjà acquise reste poursuivie au-delà du rayon d'acquisition tant qu'elle demeure aquatique, vivante et dans ce leash.
